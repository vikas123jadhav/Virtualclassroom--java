...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidCreadiantials.class)
    public ResponseEntity<?> invalidCreadiantials( InvalidCreadiantials ex, WebRequest request) {
        ErrorResponse errorDetails =
                new ErrorResponse(new Date(), HttpStatus.NOT_FOUND.toString(), ex.getMessage(), request.getDescription(false));
        return new ResponseEntity<>(errorDetails, HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<?> usernameAlreadyExists( UsernameAlreadyExists ex, WebRequest request) {
        ErrorResponse errorDetails =
                new ErrorResponse(new Date(), HttpStatus.NOT_FOUND.toString(), ex.getMessage(), request.getDescription(false));
        return new ResponseEntity<>(errorDetails, HttpStatus.NOT_FOUND);
    }
